...
const teachers: Teacher[] = [
  { name: { ar: 'أ.أسماء', en: 'Ms. Asmaa' }, subject: { ar: 'مديرة المدرسة', en: 'School Principal' }, image: '/Images/Teachers/Unknown.jpg' },
  ...
  { name: { ar: 'أ. أحمد طارق', en: 'Mr. Ahmed Tarek' }, subject: { ar: 'اللغة العربية', en: 'Arabic Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. ياسر حسين', en: 'Mr. Yasser Hussein' }, subject: { ar: 'اللغة العربية', en: 'Arabic Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. ياسر عبدالعظيم', en: 'Mr. Yasser Abdelazim' }, subject: { ar: 'اللغة العربية', en: 'Arabic Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. راضي عبدة الصيفي', en: 'Mr. Rady Abda El-Saifi' }, subject: { ar: 'اللغة العربية', en: 'Arabic Language' }, image: '/Images/Teachers/Unknown.jpg' },
  ...
  { name: { ar: 'أ. عادل عبدالعظيم', en: 'Mr. Adel Abdelazim' }, subject: { ar: 'اللغة الإنجليزية', en: 'English Language' }, image: '/Images/Teachers/Unknown.jpg' },
  ...
  { name: { ar: 'أ. سيف الدين حسن', en: 'Mr. Saif El-Din Hassan' }, subject: { ar: 'اللغة الإنجليزية', en: 'English Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. محمد محفوظ', en: 'Mr. Mohamed Mahfouz' }, subject: { ar: 'اللغة الإنجليزية', en: 'English Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. أحمد حسن', en: 'Mr. Ahmed Hassan' }, subject: { ar: 'اللغة الإنجليزية', en: 'English Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. محمد سمير', en: 'Mr. Mohamed Samir' }, subject: { ar: 'اللغة الإنجليزية', en: 'English Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. مني زكريا', en: 'Ms. Mona Zakaria' }, subject: { ar: 'اللغة الإنجليزية', en: 'English Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. أحمد علي', en: 'Mr. Ahmed Ali' }, subject: { ar: 'الرياضيات', en: 'Mathematics' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. محمود طه', en: 'Mr. Mahmoud Taha' }, subject: { ar: 'الرياضيات', en: 'Mathematics' }, image: '/Images/Teachers/Mr.Mahmoud-Taha.jpg' },
  { name: { ar: 'أ. كمال الشيمي', en: 'Mr. Kamal El-Shaimy' }, subject: { ar: 'الرياضيات', en: 'Mathematics' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. كريم عبدالله', en: 'Mr. Karim Abdullah' }, subject: { ar: 'الرياضيات', en: 'Mathematics' }, image: '/Images/Teachers/Unknown.jpg' },
  ...
  { name: { ar: 'أ. ابراهيم حسن', en: 'Mr. Ibrahim Hassan' }, subject: { ar: 'التاريخ', en: 'History' }, image: '/Images/Teachers/Unknown.jpg' },
  ...
  { name: { ar: 'أ. أنور أحمد علي', en: 'Mr. Anwar Ahmed Ali' }, subject: { ar: 'اللغة الفرنسية', en: 'French Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. حسين عبد الحميد', en: 'Mr. Hussein Abdel Hamid' }, subject: { ar: 'اللغة الفرنسية', en: 'French Language' }, image: '/Images/Teachers/Unknown.jpg' },
  { name: { ar: 'أ. دعاء عبدالفتاح', en: 'Ms. Doaa Abdel Fattah' }, subject: { ar: 'اللغة الإيطالية', en: 'Italian Language' }, image: '/Images/Teachers/Unknown.jpg' },
