...
const TypewriterTitle = ({ text, trigger }: { text: string; trigger: string }) => {
  return (
    <h1
      key={trigger}
...
export const Home = ({}: HomeProps) => {
  ...
  const features = [
    {
      icon: GraduationCap,
      title: { ar: "تعليم متميز", en: "Excellent Education" },
      description: {
        ar: "برامج أكاديمية متطورة تواكب أحدث المعايير",
        en: "Advanced academic programs meeting the latest standards",
      },
    },
    {
      icon: Shield,
      title: { ar: "تربية عسكرية", en: "Military Education" },
      description: {
        ar: "تربية عسكرية شاملة لبناء الشخصية القيادية",
        en: "Comprehensive military Education for leadership development",
      },
    },
    {
      icon: Users,
      title: { ar: "أنشطة متنوعة", en: "Diverse Activities" },
      description: {
        ar: "مجموعة واسعة من الأنشطة اللامنهجية",
        en: "Wide range of extracurricular activities",
      },
    },
    {
      icon: Award,
      title: { ar: "إنجازات مميزة", en: "Outstanding Achievements" },
      description: {
        ar: "سجل حافل بالإنجازات والجوائز",
        en: "Rich history of achievements and awards",
      },
    },
    {
      icon: BookOpen,
      title: { ar: "موارد تعليمية", en: "Learning Resources" },
      description: {
        ar: "مكتبة شاملة وموارد رقمية حديثة",
        en: "Comprehensive library and modern digital resources",
      },
    },
    {
      icon: Target,
      ...
      description: {
        ar: "رؤية واضحة لبناء جيل المستقبل",
        en: "Clear vision for building the future generation",
      },
    },
  ];

  const mainTitle = t(
    "مدرسة الأورمان الثانوية العسكرية بنين",
    "Al-Orman Secondary School for Boys"
  );
  const subTitle = t(
    "نسعى لتخريج جيل متميز يجمع بين التفوق الأكاديمي والانضباط العسكري",
    "We strive to graduate distinguished individuals combining academic excellence and military discipline"
  );
      ...
      <div className="min-h-screen">
        ...
        <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div
            ...
            style={{ backgroundImage: "url(/Images/Backgrounds/backgroundhome.png)" }}
          />
